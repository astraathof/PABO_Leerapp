...
const ontwikkelingsStadia: OntwikkelingsStadium[] = [
  ...
  {
    leeftijd: "8-9 jaar (Groep 5-6)",
    cognitief: {
      stadium: "Concreet Operationeel (Piaget)",
      kenmerken: [
        "Logisch denken met concrete objecten",
        "Begrip van behoud volledig",
        "Classificatie en seriatie",
        "Reversibiliteit begrijpen"
      ],
      voorbeelden: [
        "Wiskundige bewerkingen",
        "Wetenschappelijke experimenten",
        "Categorieën maken",
        "Stappen terugdraaien"
      ],
      onderwijsimplicaties: [
    ...
    sociaalEmotioneel: {
      stadium: "Vlijt vs. Minderwaardigheid (verdieping)",
      kenmerken: [
        "Competentie in verschillende domeinen",
        "Sociale vergelijking",
        "Groepsgevoel ontwikkelt",
        "Moreel besef groeit"
      ],
      voorbeelden: [
        "Hobby's ontwikkelen",
    ...
    fysiek: {
      ...
      motoriek: [
        "Gecompliceerde sporten",
        "Muziekinstrumenten bespelen",
        "Technische vaardigheden",
        "Artistieke expressie"
      ],
      onderwijsimplicaties: [
        "Gevarieerde sportactiviteiten",
        "Technische vaardigheden",
        "Creatieve projecten",
        "Lichaamsbeeld bespreken"
      ]
    },
    taal: {
      ontwikkeling: [
        "Vloeiend lezen",
        "Begrijpend lezen uitbreiden",
        "Schrijfvaardigheden",
        "Woordenschat verrijken"
      ],
      mijlpalen: [
        "Vlot lezen van teksten",
        "Verhalen schrijven",
        "Informatie zoeken",
        "Presentaties geven"
      ],
  ...
  },
  {
    ...
    cognitief: {
      stadium: "Overgang naar Formeel Operationeel",
      kenmerken: [
        "Abstract denken begint",
        "Hypothetisch redeneren",
        "Metacognitie ontwikkelt",
      ...
      voorbeelden: [
        ...
        "Strategieën plannen",
        "Eigen denken analyseren"
      ],
      onderwijsimplicaties: [
        "Abstract denken stimuleren",
        "Onderzoeksprojecten",
    ...
    sociaalEmotioneel: {
      stadium: "Voorbereiding Identiteit vs. Rolverwarring",
      kenmerken: [
        "Identiteit verkennen",
        "Peer groep belangrijk",
        "Onafhankelijkheid zoeken",
        "Toekomst denken"
      ],
      voorbeelden: [
        "Eigen mening vormen",
        "Vriendschappen intensiever",
        "Autoriteit bevragen",
        "Beroepen verkennen"
      ],
      onderwijsimplicaties: [
    ...
    fysiek: {
      ...
      motoriek: [
        ...
        "Fijne motoriek volwassen niveau",
        "Lichaamscontrole"
      ],
      onderwijsimplicaties: [
        "Lichaamsveranderingen bespreken",
    ...
    taal: {
      ontwikkeling: [
        "Geavanceerde leesvaardigheid",
        "Kritisch lezen",
        "Complexe teksten schrijven",
        "Argumenteren"
      ],
      mijlpalen: [
...
export default function OntwikkelingsStadiaTimeline() {
  ...
  return (
    <div className="space-y-6">
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                          <h6 className="font-medium text-gray-700 mb-2">🧠 Cognitief:</h6>
                          <p className="text-sm text-gray-600">{stadium.cognitief.stadium}</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                          <h6 className="font-medium text-gray-700 mb-2">❤️ Sociaal-Emotioneel:</h6>
                          <p className="text-sm text-gray-600">{stadium.sociaalEmotioneel.stadium}</p>
                        </div>
                      </div>
                    </div>
                  )}
      ...
      {/* Quick Reference */}
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <h3 className="font-semibold text-gray-800 mb-4">📚 Theoretische Achtergrond:</h3>
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div>
            <h4 className="font-medium text-blue-700 mb-2">🧠 Cognitieve Ontwikkeling:</h4>
            <ul className="space-y-1 text-blue-600">
              <li>• Piaget: Preoperationeel → Concreet → Formeel</li>
              <li>• Vygotsky: Zone van Naaste Ontwikkeling</li>
              <li>• Bruner: Spiraalcurriculum</li>
            </ul>
          </div>
          <div>
            <h4 className="font-medium text-red-700 mb-2">❤️ Sociaal-Emotioneel:</h4>
            <ul className="space-y-1 text-red-600">
              <li>• Erikson: Psychosociale ontwikkeling</li>
              <li>• Bowlby: Hechtingstheorie</li>
              <li>• Bandura: Sociale leertheorie</li>
            </ul>
          </div>
        </div>
      </div>
